...
public class Objective4Lab2 {
  public static void main(String[] args) {
    ...
    System.out.println("Please enter the thrid decimal you would like to add.");
    double dub3 = keyboard.nextDouble();

    int numproduct = num1+num2+num3;
    double dubproduct = dub1+dub2+dub3;

    System.out.println("The sum of " + num1 + "+" + num2 + "+" + num3 + "=" + numproduct);
    System.out.println("The sum of " + dub1 + "+" + dub2 + "+" + dub3 + "=" + dubproduct);
  }
}
